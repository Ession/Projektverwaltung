...
public class DataP
{
        ...
        try
        {
            ...
            if (!exists)
            {
                ...
                update(
                        ...
                        + "b_vortrag1 VARCHAR(30), "
                        + "b_vortrag2 VARCHAR(30) "
                        + ")");
                ...
                update("INSERT INTO projekt(p_titel, p_fach, p_kurzbeschreibung, p_beschreibung, p_skizze, p_ansprechpartner, p_teilnehmer1, p_teilnehmer2, p_teilnehmer3, b_vortrag1, b_vortrag2) "
                ...
                update("INSERT INTO organisation(o_name, o_adresse, o_ort, o_postleitzahl) "
                        + "VALUES('Fachhochschule Südwestfahlen','Frauenstuhlweg. 1','58636','Iserlohn')");
                update("INSERT INTO organisation(o_name, o_adresse, o_ort, o_postleitzahl) "
    ...
    public Vector<Benutzer> getAllBenutzer()
    {
        ...
        try
        {
            ...
            while (rs.next())
            {
                vBenutzer.add(new Benutzer(rs.getString("a_name"), rs.getString("a_vorname"), rs.getString("b_passwordhash"), rs.getString("b_email"), rs.getString("b_telefon"), rs.getString("b_adresse"), rs.getString("b_ort"), rs.getString("b_postleitzahl"), rs.getBoolean("b_isadmin")));
            }
        }
        catch (SQLException ex)
        {
